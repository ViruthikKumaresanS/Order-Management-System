...
public class ConnectionManager {
	...
	static {
		...
		ConnectionManager.url = props.getProperty("mysql.url", "jdbc:mysql:localhost/order_management_system");
		ConnectionManager.username = props.getProperty("mysql.username", "root");
		ConnectionManager.password = props.getProperty("mysql.password", "virtik1234");
